...
<!-- EDIT MODAL -->
<div id="editAccountModal" class="fixed inset-0 hidden z-50 flex items-center justify-center bg-[rgba(0,0,0,0.5)]">
...
<script src="../static/js/programchair/all_accounts.js"></script>
