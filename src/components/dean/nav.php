...
<div class="min-h-screen flex flex-col lg:flex-row">
  ...
  <aside id="sidebar" class="pc-sidebar shadow-lg w-64 lg:w-1/5 xl:w-1/6 p-6 space-y-6 lg:static fixed inset-y-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
    ...
    <nav class="space-y-4 text-left text-white overflow-y-auto h-[calc(100vh-120px)]">
      ...
      <a href="dashboard" class="nav-link flex items-center space-x-3 px-3 py-2 rounded-md transition">
        <span class="material-icons">dashboard</span>
        <span>Dashboard</span>
      </a>

      <button id="toggleAccounts" class="w-full cursor-pointer flex items-center justify-between px-3 py-2 rounded-md transition">
      ...
      <div id="accountsDropdown" class="ml-8 space-y-2 hidden">
        <a href="create_account" class="flex items-center space-x-2 px-4 py-2 rounded-md transition">
          <span class="material-icons text-sm">person_add</span>
          <span>Create</span>
        </a>
        <a href="faculty" class="flex items-center space-x-2 px-4 py-2 rounded-md transition">
          <span class="material-icons text-sm">school</span>
          <span>Faculty</span>
        </a>
        <a href="gec" class="flex items-center space-x-2 px-4 py-2 rounded-md transition">
          <span class="material-icons text-sm">groups</span>
          <span>GEC</span>
        </a>
        <a href="all" class="flex items-center space-x-2 px-4 py-2 rounded-md transition">
      ...
      <a href="report" class="nav-link flex items-center space-x-3 px-3 py-2 rounded-md transition">
        <span class="material-icons">analytics</span>
        <span>Schedule Report</span>
      </a>

      <a hidden href="curriculum" class="nav-link flex items-center space-x-3 px-3 py-2 rounded-md transition">
        <span class="material-icons">menu_book</span>
        <span>Curriculum</span>
      </a>

      <a href="subject" class="nav-link flex items-center space-x-3 px-3 py-2 rounded-md transition">
