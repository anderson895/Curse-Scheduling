...
<!-- Top Bar -->
<div class="flex justify-between items-center bg-red-900 p-4 mb-6 rounded-lg shadow">
  <h2 class="text-xl font-bold text-white uppercase tracking-wide">Subject</h2>
  <div class="w-10 h-10 bg-red-800 rounded-full flex items-center justify-center text-white font-bold">
