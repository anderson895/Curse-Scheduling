...
<div class="min-h-screen flex items-center justify-center bg-black px-4 py-8">
  ...
  <div class="w-full max-w-md bg-zinc-900 border border-yellow-400 rounded-2xl shadow-lg p-8 space-y-6">
    ...
    <div class="flex flex-col items-center space-y-3">
      ...
      <h1 class="text-3xl font-extrabold text-yellow-300 tracking-wide">Course Scheduling Login</h1>
    </div>
    ...
    <form id="frmLogin" method="POST" class="space-y-5">
      <div>
        <label for="username" class="block text-yellow-400 font-semibold mb-1">Username</label>
      ...
      <button type="submit" id="btnLogin" class="w-full cursor-pointer bg-yellow-400 text-black font-bold py-2 rounded-full hover:bg-yellow-300 transition">
        Login
      </button>
    </form>
